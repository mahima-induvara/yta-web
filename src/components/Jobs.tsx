...
export default function Jobs({ jobs }: { jobs: Job[] }) {
  ...
  <path d="M12.991 10.3334V13.725C12.991 14.025 12.9577 14.3083 12.8827 14.5667C12.5744 15.7917 11.5577 16.5583 10.1577 16.5583H7.89102L5.37435 18.2333C4.99935 18.4917 4.49934 18.2167 4.49934 17.7667V16.5583C3.64934 16.5583 2.94102 16.275 2.44935 15.7833C1.94935 15.2833 1.66602 14.575 1.66602 13.725V10.3334C1.66602 8.75002 2.64935 7.65835 4.16602 7.51668C4.27435 7.50835 4.38268 7.5 4.49934 7.5H10.1577C11.8577 7.5 12.991 8.63335 12.991 10.3334Z" stroke="#5271FF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    },
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  <path d="M6.04986 1.66669H13.9415C14.4832 1.66669 14.9665 1.68338 15.3999 1.74171C17.7082 2.00004 18.3332 3.08336 18.3332 6.05003V11.3167C18.3332 14.2834 17.7082 15.3667 15.3999 15.625C14.9665 15.6834 14.4915 15.7 13.9415 15.7H6.04986C5.50819 15.7 5.02486 15.6834 4.59153 15.625C2.28319 15.3667 1.6582 14.2834 1.6582 11.3167V6.05003C1.6582 3.08336 2.28319 2.00004 4.59153 1.74171C5.02486 1.68338 5.50819 1.66669 6.04986 1.66669Z" stroke="#5271FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M11.3164 6.93335H14.3831" stroke="#5271FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M5.61719 11.7584H5.63385H14.3922" stroke="#5271FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M5.83398 18.3333H14.1673" stroke="#5271FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M5.99607 6.91667H6.00356" stroke="#5271FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M8.74607 6.91667H8.75356" stroke="#5271FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`,
    },
    {
      id: "Cyber Security",
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 gap-10">
      {/* Pills */}
